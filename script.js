...
// Keep every video silent, including autoplay and playback restarts.
qsa('video').forEach(video => { video.defaultMuted = true; video.muted = true; video.volume = 0; video.addEventListener('volumechange', () => { if (!video.muted) video.muted = true; if (video.volume !== 0) video.volume = 0; }); });
